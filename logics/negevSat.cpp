...
rtems_task Init(rtems_task_argument )
{
	...
	if(tests){
		...
		AllTests::AllTests tests(SEND_TESTS|VALIDATOR_TESTS|WORK_QUEUE_TESTS|SEND_RECEIVE_TESTS|
								ATTITUDE_SENSORE_TESTS|DOD_SENSORE_TESTS|
								SUN_SENSORE_TESTS|TEMPERATURESENSOR_SENSORE_TESTS|
								CURRENT_SENSORE_TESTS|ATTITUDE_CONTROL_TESTS|ANTENA_TESTS
								|ENERGYPACKET_TEST|STATUSPACKET_TEST|TEMPSPACKET_TEST);
		tests.run_all_tests();
	}
